...
<head>
    ...
    <title>Activity Tracker - Reports</title>
...
<body>
        ...
        <div class="mt-3">
            <div class="row">
                <div class="col">
                    ...
                    <select id="month" class="form-select" style="width: 20em;">
                ...
                <div class="col">
                    ...
                    <select id="year" class="form-select" style="width: 20em;">
            ...
            <button class="btn btn-primary mt-2" onclick="filterData()">Filter Data</button>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Function to filter data based on month and year
            window.filterData = function() {
                var selectedMonth = $('#month').val();
                var selectedYear = $('#year').val();

                // Combine month and year to create a formatted string
                var selectedDate = selectedYear + '-' + selectedMonth;

                // Use DataTables search API to filter data
